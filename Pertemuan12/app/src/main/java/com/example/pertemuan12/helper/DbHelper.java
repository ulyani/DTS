package com.example.pertemuan12.helper;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        final String SQL_CREATE_MOVIE_TABLE = "CREATE TABLE" + TABLE_SQLite + "(" +COLUMN_ID + "INTEGER PRIMARY KET autoincrement," +COLUMN_NAME + "TEXT NOT NULL," + COLUMN_ADDRESS + "TEXT NOT NULL" + ")";
